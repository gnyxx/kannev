...
export default function BrailleLearning({ level, promptImage, signImage, onNext }) {
  return (
        ...
        <div className="w-full flex-col">
          ...
          <div className="flex mx-auto w-240 h-100 p-10 bg-bg-dark rounded space-x-50">
            <div className='select-box'>
              <img className="size-30 mx-auto mt-25" src={promptImage} alt="Prompt" />
            </div>

            <div className='select-box'>
              <img src={signImage} alt="Sign" className="mx-auto size-80" />
            </div>
          </div>
